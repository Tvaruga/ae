...
if(empty($_REQUEST['CHECK_DATES']) && $_REQUEST['CHECK_DATES']!='Y')
	$GLOBALS['TAGS_FILTER']['>=PROPERTY_START_DATE'] = ConvertDateTime($now, "YYYY-MM-DD");
?>		
...
<?$APPLICATION->IncludeComponent(
	...
	"exhibitions2", 
	array(
		"COMPONENT_TEMPLATE" => "exhibitions2",
		...
		"DETAIL_PROPERTY_CODE" => array(
			...
			4 => "TAGS",
			5 => "LIKE_QUANTITY",
			6 => "MODERATION_COMMENT",
			7 => "COMPANIES",
			8 => "CONTACT_PERSON",
			9 => "EXIBITION_LOCATION",
			10 => "REPORT",
			11 => "MORE_PHOTO",
			12 => "EXIBITION_LOCATION",
		),
