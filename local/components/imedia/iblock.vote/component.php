...
$arParams["MAX_VOTE"] = intval($arParams["MAX_VOTE"])<=0? 5: intval($arParams["MAX_VOTE"]);
$arParams["VOTE_NAMES"] = is_array($arParams["VOTE_NAMES"])? $arParams["VOTE_NAMES"]: array();
$arParams["CACHE_TYPE"] = $arParams["CACHE_TYPE"];
$arParams["CACHE_TIME"] = $arParams["CACHE_TIME"];
$arParams["DISPLAY_AS_RATING"] = $arParams["DISPLAY_AS_RATING"]=="vote_avg"? "vote_avg": "rating";
$arParams["READ_ONLY"] = $arParams["READ_ONLY"];
...
$arParams["MESSAGE_404"] = $arParams["MESSAGE_404"];
