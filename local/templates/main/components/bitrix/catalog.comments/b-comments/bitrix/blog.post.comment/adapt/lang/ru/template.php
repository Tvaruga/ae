...
$MESS['B_B_MS_COMMENT_PLACEHOLDER'] = 'Напишите ваш комментарий';
$MESS['B_B_MS_CAPTCHA_SYM'] = 'Код подтверждения (символы на картинке)';
$MESS['B_B_MS_SEND'] = 'Комментировать';
$MESS['B_B_MS_SAVE'] = 'Сохранить';
$MESS['B_B_MS_ADD_COMMENT'] = 'Комментировать';
...
$MESS['B_B_PC_MES_HIDDEN_COMMENT'] = 'Ваш комментарий будет опубликован после проверки модератором.';