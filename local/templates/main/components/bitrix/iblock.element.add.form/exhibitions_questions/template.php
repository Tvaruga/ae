...
<form name="iblock_add" action="<?=POST_FORM_ACTION_URI?>" method="post" enctype="multipart/form-data" class="b-question-form c-form m_t25">
	...
	<?if ($arParams["MAX_FILE_SIZE"] > 0):?><input type="hidden" name="MAX_FILE_SIZE" value="<?=$arParams["MAX_FILE_SIZE"]?>" /><?endif?>
					...
					<?
						...
						switch ($INPUT_TYPE):
							...
							case "T":
								...
								?>
						<textarea cols="<?=$arResult["PROPERTY_LIST_FULL"][$propertyID]["COL_COUNT"]?>" resize="none" rows="<?=$arResult["PROPERTY_LIST_FULL"][$propertyID]["ROW_COUNT"]?>" name="PROPERTY[<?=$propertyID?>][<?=$i?>]"><?=$value?></textarea>
								<?
								}
							break;
							...
							case "N":
								...
								?>
								<input type="text" name="PROPERTY[<?=$propertyID?>][<?=$i?>]" size="25" value="<?=$value?>"  class="input c-form-item__input"/><?
		...
		<div class="form-wrapper">
			<input type="submit" name="iblock_submit" class="button m_t25" value="<?=GetMessage("IBLOCK_FORM_SUBMIT")?>" />
		</div>
</form>