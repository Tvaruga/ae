...
$strNameFormatted = CUser::FormatName($arParams['NAME_TEMPLATE'], $arTmpUser, $bUseLogin);
	$arTmpUser["DETAIL_URL"]='/forum/?PAGE_NAME=profile_view&UID='.$arResult["User"]["ID"];	
...
$strCard = '<div class="'.$data_cont_class.'" id="bx_user_info_data_cont_'.$arTmpUser["ID"].'">123415641';
