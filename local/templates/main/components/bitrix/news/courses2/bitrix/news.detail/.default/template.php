...
<div class="b-page-head b-page-head_event">
	<div class="b-page-head__row">
		...
		<? if ($arResult['PROPERTIES']['INVITATION']['VALUE_XML_ID']=='Y'){?>
			<div class="b-page-head__tools">
	...
	<div class="b-page-head__row m_t10">
		<? if ($arResult['DISPLAY_PROPERTIES']['START_DATA']['DISPLAY_VALUE']!=''){?>
			<div class="b-page-head__info">
				<div class="b-page-head__info__item"><?=$arResult['DISPLAY_PROPERTIES']['START_DATA']['DISPLAY_VALUE']?></div>
			</div>	
		<?}?>
		<!--
<div class="b-page-head__info">
	        <div class="b-page-head__info__item">Начало в  <b>11:00</b></div>
	      </div>
-->
		<div class="b-page-head__tools">
	...
	<div class="b-tabs-menu m_t20">
		<ul class="b-tabs-menu__holder">
			<? if ($arResult['PRINT_PICTURE']['src']!='' || $arResult['DETAIL_TEXT']!=''){?>
				<li class="b-tabs-menu__item active"><a href="#tab-0" class="b-tabs-menu__link">О курсе</a></li>
			<?}?>
			<? if (!empty($arResult['DISPLAY_PROPERTIES']['COMPANIES']['DISPLAY_VALUE'])){?>
				 <li class="b-tabs-menu__item"><a href="#tab-1" class="b-tabs-menu__link">Преподаватели</a></li>	
			<?}?>
			<? if ($arResult['PROPERTIES']['REPORT']['VALUE']['TEXT']!='' || !empty($arResult['PROPERTIES']['MORE_PHOTO']['VALUE'])){?>   
			<li class="b-tabs-menu__item"><a href="#tab-2" class="b-tabs-menu__link">Отчет</a></li>
			<?}?>
		<li class="b-tabs-menu__item"><a href="#tab-3" class="b-tabs-menu__link">Задать вопрос</a></li>
		</ul>
	</div>
	<? if ($arResult['PRINT_PICTURE']['src']!='' || $arResult['DETAIL_TEXT']!=''){?>
